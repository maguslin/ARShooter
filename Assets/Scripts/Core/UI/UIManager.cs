...
using UnityEngine;
using FairyGUI;
public class UIManager : UnityAllSceneSingletonVisible<UIManager>
{
	...
	public void InitFairyGUI()
	{
        ...
        //分辨率适配
        //1280*720 6s:1334*750 1920*1080 iphonex:2436*1125 
        GRoot.inst.SetContentScaleFactor(1334, 750, FairyGUI.UIContentScaler.ScreenMatchMode.MatchWidth);
        UIConfig.defaultFont = "hwxs";
        //基础ui
