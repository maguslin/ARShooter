...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		MagusSceneManagerWrap.Register(L);
		MapSceneManagerWrap.Register(L);
		ConstantTableWrap.Register(L);
		SceneIDWrap.Register(L);
		MsgTypeWrap.Register(L);
		MagusEventListenerWrap.Register(L);
		UnityAllSceneSingleton_GameManagerWrap.Register(L);
		UnityAllSceneSingleton_MagusSceneManagerWrap.Register(L);
		UnityAllSceneSingletonVisible_MapSceneManagerWrap.Register(L);
		UnityAllSceneSingleton_MapSceneManagerWrap.Register(L);
